...
with beam.Pipeline() as p:
  ...
  numbers: beam.PCollection[int] = p | beam.Create([1, 2, 3, 4, 5])

  mult5_results: beam.PCollection[int] = numbers | beam.Map(lambda v: v * 5)
  mult10_results: beam.PCollection[int] = numbers | beam.Map(lambda v: v * 10)
