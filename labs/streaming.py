"""
    Serverless Data Processing with Dataflow - Using Dataflow for Streaming Analytics (Python) from
...
def run():
    ...
    parsed_msgs = (p | 'ReadFromPubSub' >> beam.io.ReadFromPubSub(topic=input_topic)
    ...
    #second_branch
    (parsed_msgs
        | "WindowByMinute" >> beam.WindowInto(beam.transforms.window.FixedWindows(60))
